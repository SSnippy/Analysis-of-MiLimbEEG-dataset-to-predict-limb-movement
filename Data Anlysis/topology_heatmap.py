...
META_PATH = os.path.join(PROJECT_ROOT, "datapoints", "metadata.xlsx")
...
csv_path = os.path.join(PROJECT_ROOT, meta.loc[0, "filtered_url"])
...
to_save=os.path.join(PROJECT_ROOT, "plots", "topology_heatmap.png")
